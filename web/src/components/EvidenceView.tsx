        ...
        <section className="evidence-section benchmark-section" aria-labelledby="advantage-title">
          ...
          {publishedFounderAdvantage ? (
            <div className="claim-warning published">
              ...
              <span><strong>Founder-operated comparison published.</strong>{publishedFounderAdvantage.exactOutputParityCount}/3 tasks record exact canonical output parity and {publishedFounderAdvantage.recordedSpeedAdvantageCount}/3 record lower agent time. Quality score: not assigned (<code>null</code>). This comparison is non-independent and non-blind. <a href={publishedFounderAdvantage.reportUrl} target="_blank" rel="noreferrer">Inspect the bounded report.</a></span>
            </div>
